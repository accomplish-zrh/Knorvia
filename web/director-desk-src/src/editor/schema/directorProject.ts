...
import type { DirectorCameraBody, DirectorCameraSensor, DirectorLensPreset } from "./cameraOptics";
...
export interface DirectorCameraShot {
  ...
  isVirtual?: boolean;
  fov: number;
  /** Physical-camera metadata used for lens planning and downstream generation prompts. */
  cameraBody?: DirectorCameraBody;
  sensorPreset?: DirectorCameraSensor;
  lensPreset?: DirectorLensPreset;
