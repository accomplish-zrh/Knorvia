 ...
 * renderer (see ``./previewers/*.tsx``). DOCX/XLSX/PPTX have dedicated
 * previewers; legacy Office binaries fall back to extracted text.
 */
...
// Legacy Office binaries with no reliable browser renderer — fall back to
// the extractor's plain text.
const OFFICE_BINARY_EXTS = new Set([".ppt", ".doc", ".xls"]);
