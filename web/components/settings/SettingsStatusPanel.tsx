...
const readDesktopRuntime = () => Boolean(window.knorviaDesktop);
const readDesktopRuntimeServer = () => false;
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-[13px] font-medium leading-none tracking-tight text-[var(--foreground)]">
            {desktop ? (t("Desktop Engine") || "Desktop Engine") : t("Backend")}
          </span>
