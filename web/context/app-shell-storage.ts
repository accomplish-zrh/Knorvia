...
export const ACTIVE_SESSION_STORAGE_KEY = "knorvia.activeSessionId.tab";
export const LANGUAGE_STORAGE_KEY = "knorvia-language";
export const RESPONSE_LANGUAGE_STORAGE_KEY = "knorvia-response-language";
export const SIDEBAR_COLLAPSED_STORAGE_KEY = "knorvia.sidebarCollapsed";
export const CHAT_RESPONSE_TIMEOUT_STORAGE_KEY =
  "knorvia.chatResponseTimeout";
export const CODE_BLOCK_THEME_STORAGE_KEY = "knorvia.code-block-theme";
export const CODE_BLOCK_SHOW_LINE_NUMBERS_STORAGE_KEY =
  "knorvia.code-block-show-line-numbers";
export const CODE_BLOCK_WRAP_LONG_LINES_STORAGE_KEY =
  "knorvia.code-block-wrap-long-lines";
...
export const ACTIVE_SESSION_EVENT = "knorvia:active-session";
export const LANGUAGE_EVENT = "knorvia:language";
export const RESPONSE_LANGUAGE_EVENT = "knorvia:response-language";
export const SIDEBAR_COLLAPSED_EVENT = "knorvia:sidebar-collapsed";
export const CODE_BLOCK_SETTINGS_EVENT = "knorvia:code-block-settings";
