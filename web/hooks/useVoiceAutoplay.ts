...
const SESSION_KEY_PREFIX = "knorvia.voiceAutoplay.session"; // "on" | "off"
const PROMPTED_KEY_PREFIX = "knorvia.voiceAutoplay.prompted"; // "1"
const GLOBAL_EVENT = "knorvia:voice-autoplay-global";
const SESSION_EVENT = "knorvia:voice-autoplay-session";
