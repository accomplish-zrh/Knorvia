...
export const CO_WRITER_SAMPLE_TEMPLATE = `# Knorvia Co-Writer

> Knorvia's built-in writing canvas for notes, reports, tutorials, and AI-assisted drafts.
...
- A practical starter draft for Knorvia product docs and learning content

## Headers (Underline)

Knorvia Learning Note
=============

Knorvia Study Outline
-------------
...
The <abbr title="Large Language Model">LLM</abbr> layer powers Knorvia while the <abbr title="Retrieval Augmented Generation">RAG</abbr> layer provides grounded knowledge support.

### Blockquotes

> Knorvia helps students turn questions into structured understanding.
>
> "Learn deeply, write clearly.", [Knorvia](#knorvia-co-writer)

### Links

[Knorvia Co-Writer](#knorvia-co-writer "co-writer section")

[Knorvia Learning Note](#knorvia-learning-note)

[Knorvia workspace](/home)

[Reference link][knorvia-doc]

[knorvia-doc]: #knorvia-learning-note

### Code Blocks

#### Inline code

\`knorvia chat --once "Summarize this section"\`

#### Code Blocks (Indented style)

    from knorvia.runtime.orchestrator import ChatOrchestrator
    orchestrator = ChatOrchestrator()
    print("Knorvia is ready.")
...
> Knorvia brand mark used inside the co-writer template.
...
- [x] Draft a Knorvia product note
...
op=>operation: Knorvia analyzes intent
...
${FENCE}seq
Student->Knorvia: Ask for help
Knorvia->KnowledgeBase: Load context
Note right of Knorvia: Collect memory\\nand relevant knowledge
Knorvia-->Student: Return guided response
Student->>Knorvia: Request rewrite in co-writer
${FENCE}
