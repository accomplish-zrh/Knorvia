...
function safeNextPath(raw: string | null): string {
  ...
  // protocol-relative //host so /login?next=https://evil.com cannot turn
  // a successful login into an open redirect.
  if (!raw) return "/";
...
export default function LoginPage() {
  // Sync-bundled resources make t() available even in the pre-mount
