      ...
      >
        <div className="py-4">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-7">
            {(
              [
                ...
                { id: "ocean-glass", label: t("Ocean Glass") },
                { id: "aurora-glass", label: t("Aurora Glass") },
                { id: "rose-glass", label: t("Rose Glass") },
              ] as const
            ).map(({ id, label }) => (
              <ThemePreviewCard
                key={id}
          ...
          <p className="mt-4 text-[11.5px] leading-relaxed text-[var(--muted-foreground)]/80">
            {t(
              "Default is a clean pure-white theme with a blue accent. Cream is warm and paper-like with a terracotta accent. Dark keeps Cream's warmth on near-black. The glass themes add translucent panels over deep gradients — in the desktop app they also enable the native acrylic backdrop, so your desktop wallpaper shows through.",
            )}
          </p>
        </div>
      </SettingSection>
