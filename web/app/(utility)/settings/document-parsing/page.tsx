...
const PIP_HINT: Record<string, string> = {
  docling: "pip install knorvia[parse-docling]",
  markitdown: "pip install knorvia[parse-markitdown]",
  pymupdf4llm: "pip install knorvia[parse-pymupdf4llm]",
  liteparse: "pip install knorvia[parse-liteparse]",
};
  ...
  return (
    ...
    >
      <SettingRow
        ...
        description={t(
          "Reserved — uses Knorvia's vision model to caption images during conversion.",
        )}
        control={
          <Toggle
            checked={llmImages}
