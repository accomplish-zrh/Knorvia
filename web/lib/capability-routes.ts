/**
 * Model capability a feature depends on. LLM, image and video workspaces are
 * granted independently per user; embedding/search remain shared admin
 * infrastructure and are not route gates.
 */
export type Capability = "llm" | "imagegen" | "videogen";
...
export const ROUTE_CAPABILITIES: ReadonlyArray<{
  ...
  { prefix: "/image-studio", capability: "imagegen" },
  { prefix: "/video-studio", capability: "videogen" },
...
export const CAPABILITY_LABEL: Record<Capability, string> = {
  llm: "an LLM model",
  imagegen: "an image generation model",
  videogen: "an AI video generation model",
};
