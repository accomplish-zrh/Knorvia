 ...
 * several agents out of the same folder (e.g. "Knorvia work" vs "research").
...
export interface ImportAgent {
  ...
  /** Server-detected default home (no folder picker / no handle). */
...
const DB_NAME = "knorvia-chat-import";
const STORE = "agents";
