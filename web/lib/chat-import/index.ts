 ...
 * parse the chosen sessions into the upload payload. All file reading happens
 * on this computer via the folder picker — those files stay on the user's
 * machine until they choose what to import.
 */
