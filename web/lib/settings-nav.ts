...
const MODEL_CHILDREN: SettingsLeaf[] = [
  ...
  },
  {
    key: "imagegen",
    href: "/settings/image",
    label: { zh: "图片模型", en: "Image Models" },
    blurb: {
      zh: "视觉创作与对话 Agent 共用的图片模型，支持生成、编辑和局部重绘。",
      en: "Image models shared by Image Studio and the chat agent: generate, edit, and local redraw.",
    },
    icon: ImageIcon,
  ...
  },
  {
    key: "videogen",
    href: "/settings/video",
    label: { zh: "视频模型", en: "Video Models" },
    blurb: {
      zh: "视频创作工作台与对话 Agent 共用的视频模型、能力与默认参数。",
      en: "Video models, capabilities, and defaults shared by Video Studio and the chat agent.",
    },
    icon: Clapperboard,
...
const AGENT_CHILDREN: SettingsLeaf[] = [
  {
    ...
    blurb: {
      zh: "Knorvia 调用本机 Claude Code 时的模型、推理强度与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "Knorvia 调用本机 Codex 时的模型、推理强度与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "Knorvia 调用本机 Gemini CLI 时的模型与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "Knorvia 调用本机 Kimi CLI 时的模型与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "Knorvia 调用本机 opencode 时的模型、推理强度与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "Knorvia 调用本机 MiMo Code 时的模型、推理强度与运行参数。",
  ...
  {
    key: "agent-grok-build",
    href: "/settings/agents/grok-build",
    label: { zh: "Grok Build", en: "Grok Build" },
    blurb: {
      zh: "Knorvia 调用本机 Grok Build 时的模型、推理强度与运行参数。",
      en: "Model, reasoning effort, and run params for the local Grok Build.",
    },
    icon: GrokBuildGlyph as unknown as LucideIcon,
    tile: "bg-zinc-800/10 text-zinc-800 dark:text-zinc-200",
    adminOnly: true,
  },
];
...
const STORAGE_PATHS: Record<string, string> = {
  ...
  "/settings/agents/grok-build": "data/user/settings/subagent.json",
};
