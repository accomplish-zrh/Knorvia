...
class CodeBuddyAuthService:
    ...
    async def logout(self) -> dict[str, Any]:
        """Disconnect Knorvia from the CodeBuddy session on this host.
        ...
        # Knorvia does not own this credential: it is the session the IDE
        ...
        from knorvia.core.agentic.client import reset_agentic_client_pool
        from knorvia.services.codebuddy_credentials import load_credentials
    ...
    async def _probe_local_login(self) -> bool:
        ...
        """
        from knorvia.services.codebuddy_credentials import load_credentials, probe_account
