"""Legacy public-API shims for :mod:`knorvia.services.memory.store`.
...
from knorvia.services.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from knorvia.services.memory.document import parse, serialize
from knorvia.services.memory.ops import ApplyReport, Op
