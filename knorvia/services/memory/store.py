...
from knorvia.services.memory import consolidator, paths, trace
from knorvia.services.memory.consolidator import ConsolidateResult, OnEvent
from knorvia.services.memory.document import Document, parse, serialize
from knorvia.services.memory.ops import AddOp, ApplyReport, EditOp, OpResult
from knorvia.services.memory.ops import apply as ops_apply
...
_NO_MEMORY = (
    "(No memory available — interact with Knorvia and update from the Memory page to build one.)"
)
...
class MemoryStore:
    ...
    async def apply_ops_payload(
        ...
        """
        from knorvia.services.memory.consolidator import _parse_ops_response
