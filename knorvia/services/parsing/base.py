...
stage. An engine turns bytes/path into a :class:`~knorvia.services.parsing.types.ParsedDocument`
...
class Parser(Protocol):
    ...
    def parse(
        ...
        *,
        ...
        workdir via :func:`knorvia.services.parsing.cache.load_ir` and writes
