...
* builtin — shipped with the product under ``knorvia/skills/builtin/``,
...
:mod:`knorvia.services.persona` and are eagerly injected because a persona
...
class SkillService:
    ...
    def install_tree(
        ...
        * ``extra_tags`` are merged into the package's own tags (the hub
          installer stamps the source hub, e.g. ``clawhub``, this way);
