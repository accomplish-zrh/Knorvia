...
Unified configuration loading for all Knorvia modules.
...
def parse_language(language: Any) -> str:
    ...
    from knorvia.services.prompt.language import normalize_language
...
def get_agent_params(module_name: str) -> dict:
    ...
    from knorvia.services.setup.init import DEFAULT_AGENTS_SETTINGS
