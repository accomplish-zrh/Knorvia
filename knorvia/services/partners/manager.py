...
Each partner runs as a set of asyncio tasks within the Knorvia server
...
from knorvia.partners.config.paths import (
    get_data_dir,
    get_partner_dir,
...
class PartnerManager:
    ...
    async def _outbound_router(self, partner_id: str, bus: Any, instance: PartnerInstance) -> None:
        ...
        try:
            ...
            from knorvia.partners.bus.events import OutboundMessage as _OMsg
