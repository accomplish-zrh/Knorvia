...
Knorvia runs on the same machine as the user's configured agent CLIs — Claude
Code, Codex, Gemini CLI, Kimi CLI, opencode, MiMo Code, Grok Build — so the backend can
...
from knorvia.services.subagent.partner import PARTNER_BACKEND_KIND
from knorvia.services.subagent.registry import detect_all, get_backend, list_backend_kinds
