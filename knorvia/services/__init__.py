...
Unified service layer for Knorvia providing:
...
Usage:
    ...
    from knorvia.services.embedding import get_embedding_client
    from knorvia.services.rag import RAGService
...
def __getattr__(name: str):
    ...
    if name == "llm":
        return importlib.import_module("knorvia.services.llm")
    if name == "prompt":
        return importlib.import_module("knorvia.services.prompt")
    if name == "search":
        return importlib.import_module("knorvia.services.search")
    if name == "setup":
        return importlib.import_module("knorvia.services.setup")
    if name == "session":
        return importlib.import_module("knorvia.services.session")
    if name == "config":
        return importlib.import_module("knorvia.services.config")
    if name == "rag":
        return importlib.import_module("knorvia.services.rag")
    if name == "embedding":
        return importlib.import_module("knorvia.services.embedding")
