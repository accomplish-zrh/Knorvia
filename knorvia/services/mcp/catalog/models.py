...
:class:`~knorvia.services.mcp.config.MCPServerConfig`, the only server shape
the rest of Knorvia understands.
...
:mod:`knorvia.services.mcp.secrets` resolves in memory at connect time. That
...
from knorvia.services.mcp.secrets import secret_reference
