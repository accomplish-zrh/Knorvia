...
class TTSConfig:
    ...
    voice: str = ""
    # §Phase D4: gateway-configured custom voice ids (from the model catalog's
    # ``custom_voices`` array). Pure metadata for voice enumeration/audition —
    # never sent on the synthesis wire; ``voice`` above is what's sent.
