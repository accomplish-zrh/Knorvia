...
from knorvia.services.cli_apps.models import APP_ID_RE, AppRuntime, InstallKind
from knorvia.services.cli_apps.paths import ensure_root, state_path
...
def prefs_path(owner_id: str) -> Path:
    ...
    """
    from knorvia.multi_user.paths import SYSTEM_ROOT
