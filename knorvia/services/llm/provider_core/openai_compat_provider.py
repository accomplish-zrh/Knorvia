...
from knorvia.services.llm.capabilities import disable_response_format_at_runtime
...
if TYPE_CHECKING:
    from knorvia.services.provider_registry import ProviderSpec
