...
Usage:
    from knorvia.services.llm.capabilities import get_capability, supports_response_format
...
MODEL_OVERRIDES: dict[str, dict[str, object]] = {
    ...
    # Some compatible providers reject this capability probe.
    "gpt-5": {
...
def threads_session_id(binding: str | None) -> bool:
    """Whether *binding* expects ``knorvia_session_id`` on each request."""
