...
from knorvia.services.videogen.base import BaseVideogenAdapter

_async_task = AsyncTaskVideogenAdapter()
VIDEOGEN_ADAPTERS: dict[str, BaseVideogenAdapter] = {
    # The legacy facade already implements Volcengine/Seedance prompt command
    # shaping. Keep its explicit runtime name as an alias while new Video
    # Studio jobs use the richer provider registry.
    "async_task": _async_task,
    "volcengine_async_task": _async_task,
}
