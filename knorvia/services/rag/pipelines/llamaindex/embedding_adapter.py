"""LlamaIndex embedding adapter backed by Knorvia's embedding service."""
...
from knorvia.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
from knorvia.services.embedding.validation import validate_embedding_batch
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for Knorvia embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for Knorvia's current embedding config."""
