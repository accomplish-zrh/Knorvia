    ...
    return _finalize(
        [
            _check(
                ...
                installed,
                "Installed." if installed else "pip install 'knorvia[graphrag]'",
            ),
            _check(
                "chat",
                "Active chat model",
...
def _lightrag_preflight() -> dict:
    ...
    if chat_model:
        try:
            from knorvia.services.llm.capabilities import supports_vision
    ...
    return _finalize(
        [
            _check(
                ...
                installed,
                "Installed." if installed else "pip install 'knorvia[rag-lightrag]'",
            ),
            _check(
                "chat",
                "Active chat model",
