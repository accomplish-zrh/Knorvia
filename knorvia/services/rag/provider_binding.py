...
Knorvia owns the knowledge-base lifecycle and stores the authoritative
...
from knorvia.services.rag.factory import DEFAULT_PROVIDER, normalize_provider_name
...
def resolve_bound_provider(kb_base_dir: str | Path, kb_name: str | None) -> str:
    """Resolve the provider Knorvia has bound to a KB.
