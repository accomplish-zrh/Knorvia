...
from knorvia.agents._shared.capability_result import emit_capability_result
...
from knorvia.agents.research.data_structures import (
    DynamicTopicQueue,
    ToolTrace,
    TopicBlock,
    TopicStatus,
...
from knorvia.core.agentic.tool_dispatch import (
...
from knorvia.services.config import parse_language
from knorvia.services.llm import get_llm_config, prepare_multimodal_messages
...
from knorvia.services.sandbox import exec_capability_available
...
class ResearchPipeline:
    ...
    LLM call goes through :mod:`knorvia.core.agentic` primitives. The
    ...
    def __init__(
        ...
        *,
        ...
        if self.kb_name:
            try:
                from knorvia.knowledge.kb_types import OBSIDIAN_KB_TYPE
                from knorvia.multi_user.knowledge_access import resolve_kb_metadata
...
class _RephraseLoopHost:
    ...
    async def resolve_pause(self, dispatch: DispatchOutcome) -> bool:
        from knorvia.agents.chat.agentic_pipeline import (
