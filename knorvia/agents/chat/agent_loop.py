...
from knorvia.agents.chat.context_budget import LLMRequestSnapshot
from knorvia.agents.chat.dsml_tool_calls import DSMLStreamFilter, extract_dsml_tool_calls
...
from knorvia.core.agentic.usage import message_content_chars, record_streamed_usage
...
from knorvia.services.llm.capabilities import threads_session_id
from knorvia.services.llm.multimodal import should_degrade_to_text, strip_image_parts_inplace
from knorvia.services.llm.request_compat import (
    ...
    async def _call_llm(
        ...
        *,
        ...
        if threads_session_id(self.pipeline.binding):
            kwargs["knorvia_session_id"] = self.context.session_id
