...
class VisualizeCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        from knorvia.agents.visualize.models import ReviewResult
    ...
    async def _run_manim_path(
        ...
        *,
        ...
        from knorvia.agents.math_animator.pipeline import MathAnimatorPipeline
        from knorvia.agents.math_animator.request_config import MathAnimatorRequestConfig
        from knorvia.core.trace import build_trace_metadata, new_call_id
        from knorvia.services.llm.config import get_llm_config
