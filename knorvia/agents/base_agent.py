...
from knorvia.config.settings import settings
from knorvia.logging import LLMStats
from knorvia.services.config import get_agent_params
...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"knorvia.{logger_name}")
