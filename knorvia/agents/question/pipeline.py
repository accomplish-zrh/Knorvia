...
to :mod:`knorvia.core.agentic` and the shared tool-composition policy.
"""
...
from knorvia.core.agentic.labels import find_inline_labels
    ...
    async def _summarize_tool_result(
        ...
        *,
        ...
        meta = build_trace_metadata(
            ...
            label=self._t("labels.reflecting", default="Knorvia Reflecting..."),
        ...
        await stream.progress(
            self._t("labels.reflecting", default="Knorvia Reflecting..."),
            source=SOURCE,
            stage=STAGE_EXPLORING,
