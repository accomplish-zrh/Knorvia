...
class DeepQuestionCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        if isinstance(followup_question_context, dict) and followup_question_context.get(
            ...
            from knorvia.agents.question.agents.followup_agent import FollowupAgent
        ...
        if mode != "mimic":
            ...
            from knorvia.agents.question.history import load_session_quiz_history
            from knorvia.agents.question.pipeline import QuestionPipeline
            from knorvia.agents.question.request_config import (
    ...
    async def _run_mimic_mode(
        ...
        * ``[Attached Documents]`` in  → no paper available; fall back to
        ...
        """
        from knorvia.agents.question.history import load_session_quiz_history
        from knorvia.agents.question.mimic_source import (
        ...
        from knorvia.services.config import load_config_with_main
        from knorvia.services.parsing.engines.mineru.config import MinerUError
