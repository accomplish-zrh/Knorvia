...
from knorvia.core.capability_protocol import BaseCapability
from knorvia.i18n.metadata_i18n import capability_description_i18n
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("knorvia.plugins.loader")
    except Exception:
