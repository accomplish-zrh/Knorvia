...
Two things the process-global :class:`~knorvia.runtime.registry.tool_registry.ToolRegistry`
...
from knorvia.core.tool_protocol import BaseTool, ToolDefinition, ToolLookup, ToolResult
from knorvia.runtime.providers.allowlist import Allowlist
from knorvia.tools.prompting import compose_prompt_text
...
class ScopedToolRegistry:
    ...
    Satisfies :class:`~knorvia.core.tool_protocol.ToolLookup`. Intentionally
