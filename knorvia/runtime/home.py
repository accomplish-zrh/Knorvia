"""Runtime home resolution for installed and source Knorvia runs."""
...
def get_runtime_home(home: str | Path | None = None) -> Path:
    ...
    2. ``KNORVIA_HOME`` environment variable.
    ...
    raw = home if home is not None else os.getenv(KNORVIA_HOME_ENV)
