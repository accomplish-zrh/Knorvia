...
from knorvia.core.tool_protocol import BaseTool, ToolLookup
from knorvia.runtime.providers.allowlist import Allowlist
from knorvia.runtime.providers.authorize import authorize_mcp_tools
from knorvia.runtime.providers.scope import ToolScope
from knorvia.runtime.registry.deferred_tools import (
    DeferredToolLoader,
    provider_identity,
...
async def _build(
    *,
    ...
    from knorvia.services.mcp import get_mcp_manager, load_loaded_tools
...
def _cli_app_tools(scope: ToolScope) -> list[BaseTool]:
    ...
    if scope.exclusive_capability:
        return []
    try:
        from knorvia.multi_user.tool_access import allowed_cli_apps, exec_override
        from knorvia.services.cli_apps.provider import authorized_apps, build_app_tools
...
def _user_grant(scope: ToolScope) -> Allowlist:
    ...
    from knorvia.multi_user.tool_access import allowed_mcp_tools
