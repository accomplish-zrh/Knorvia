...
:mod:`knorvia.capabilities` (``solve``, ``mastery``). The chat loop imports
...
from knorvia.capabilities.protocol import KnowledgeCapability, LoopCapability, PromptBlock
from knorvia.capabilities.registry import (
    LOOP_CAPABILITIES,
