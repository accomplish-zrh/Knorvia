...
mastery engine (:mod:`knorvia.learning`).
...
from knorvia.capabilities.mastery.choices import (
    format_options,
    has_option_bodies,
    parse_options,
...
from knorvia.learning.pending import public_pending_question
from knorvia.learning.policy import (
    QUALITATIVE_TYPES,
    display_mastery,
...
if TYPE_CHECKING:
    from knorvia.learning.service import LearningService
...
class MasteryGradeTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        ...
        if not path_id:
            return _no_path_result()
        from knorvia.learning.scheduler import SpacedRepetitionScheduler
