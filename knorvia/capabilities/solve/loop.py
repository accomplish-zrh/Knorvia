...
:class:`knorvia.capabilities.solve.capability.DeepSolveCapability`.
"""
...
from knorvia.capabilities.protocol import PromptBlock
from knorvia.capabilities.solve.session import DEFAULT_MAX_REPLANS, get_session
