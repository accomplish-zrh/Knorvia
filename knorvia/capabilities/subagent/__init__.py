...
through :mod:`knorvia.services.subagent` and streaming its native run to the
...
from knorvia.capabilities.subagent.binding import connection_for_turn
from knorvia.capabilities.subagent.capability import SubagentCapability
from knorvia.capabilities.subagent.tools import (
    SUBAGENT_TOOL_NAMES,
    SUBAGENT_TOOL_TYPES,
    ConsultSubagentTool,
)
