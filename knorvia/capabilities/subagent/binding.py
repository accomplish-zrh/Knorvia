...
Mirrors :mod:`knorvia.capabilities.obsidian.binding`: the binding is derived
...
def _resolve(context: UnifiedContext) -> dict[str, str] | None:
    ...
    for ref in context.knowledge_bases or []:
        ...
        from knorvia.services.subagent import PARTNER_BACKEND_KIND, load_subagent_settings
