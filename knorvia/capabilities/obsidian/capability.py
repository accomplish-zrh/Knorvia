...
vault (resolved by :mod:`knorvia.capabilities.obsidian.binding`). As a
...
from knorvia.capabilities.obsidian.binding import obsidian_vault_refs, vault_for_turn
from knorvia.capabilities.obsidian.tools import OBSIDIAN_TOOL_NAMES
