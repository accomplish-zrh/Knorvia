...
:class:`~knorvia.capabilities.obsidian.capability.ObsidianCapability`, which
...
:mod:`knorvia.capabilities.obsidian.vault` operations.
...
from knorvia.capabilities.obsidian import vault as vault_ops
