...
class KnorviaError(Exception):
    """Base class for all application errors in Knorvia."""
...
class ConfigurationError(KnorviaError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(KnorviaError):
    """Raised when input validation fails."""

    pass


class ServiceError(KnorviaError):
