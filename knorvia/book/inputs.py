...
Reuses:
- ``knorvia.services.session.get_sqlite_session_store`` for chat history
- ``knorvia.services.notebook.notebook_manager`` for notebook records
- ``knorvia.agents.notebook.NotebookAnalysisAgent`` for context distillation
"""
