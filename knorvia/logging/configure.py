...
_CONFIGURED = False
_MANAGED_ATTR = "_knorvia_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    logging.getLogger("knorvia").setLevel(logging.DEBUG)
    logging.getLogger("knorvia").propagate = True
