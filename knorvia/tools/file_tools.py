        ...
        try:
            ...
            for item in sorted(iterator):
                ...
                if len(items) < cap:
                    ...
                    # as_posix(): consistent forward slashes in the listing on
                    # every platform (the output is read by the model and by
                    # tests; Windows backslashes there are pure noise).
