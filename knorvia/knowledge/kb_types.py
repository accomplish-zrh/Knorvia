...
Kept in its own low-level module so both :mod:`knorvia.knowledge.manager`
...
def supports_local_raw_files(entry: Any) -> bool:
    """Whether the KB owns a Knorvia-managed local ``raw/`` directory.
    ...
    Knorvia's raw-file upload and management API.
    """
