...
from knorvia.core.i18n import current_language
from knorvia.i18n.metadata_i18n import localized_description, tool_description_i18n
...
async def build_tool_options(
    *, exclude_builtin: set[str] | None = None
    ...
    from knorvia.runtime.registry.deferred_tools import provider_identity
    from knorvia.runtime.registry.tool_registry import get_tool_registry
    from knorvia.tools.builtin import CONFIGURABLE_BUILTIN_TOOL_NAMES
