...
from knorvia.core.tool_protocol import BaseTool, ToolDefinition, ToolPromptHints
from knorvia.i18n.metadata_i18n import tool_description_i18n
...
async def list_builtin_tools() -> ToolsListResponse:
    ...
    from knorvia.capabilities import capability_tool_owners
