...
from knorvia.services.mcp import MCPServerConfig, get_mcp_manager, load_mcp_config, oauth
from knorvia.services.mcp.catalog import (
    build_server_config,
    category_counts,
    get_entry,
    search_catalog,
...
from knorvia.services.mcp.secrets import configured_fields, delete_secrets, store_secrets
from knorvia.services.mcp.user_config import (
...
def _extract_credentials(
    ...
    """
    from knorvia.services.mcp.secrets import SECRET_REFERENCE_RE, secret_reference
