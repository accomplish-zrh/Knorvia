...
Why live here vs inside ``knorvia.partners.channels``?
...
from knorvia.services.partners.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    """
    from knorvia.partners.channels.registry import discover_all_with_errors
