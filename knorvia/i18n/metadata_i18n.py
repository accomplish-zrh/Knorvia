...
_TOOL_DESCRIPTIONS: dict[str, dict[str, str]] = {
    ...
    "imagegen": {
        "en": "Create and revise images through Image Studio with an assigned model.",
        "zh": "通过视觉创作，用已分配的模型生成或修改图片。",
    },
    "videogen": {
        "en": "Create and revise videos through Video Studio with the assigned model.",
        "zh": "通过视频工作台，用已分配的模型生成或修改视频。",
    },
    "library": {
