...
from knorvia.partners.config.paths import get_media_dir, get_runtime_subdir
from knorvia.partners.config.schema import DeliveryOverrides
from knorvia.partners.helpers import safe_filename, split_message
...
class WeixinChannel(BaseChannel):
    ...
    async def _send_text(
        ...
        client_id = f"knorvia-{uuid.uuid4().hex[:12]}"
