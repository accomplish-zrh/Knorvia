...
memory_router = importlib.import_module("knorvia.api.routers.memory").router
paths_mod = importlib.import_module("knorvia.services.memory.paths")
document_mod = importlib.import_module("knorvia.services.memory.document")
