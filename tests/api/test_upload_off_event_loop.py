...
from knorvia.api.routers import knowledge as knowledge_router
from knorvia.knowledge.add_documents import DocumentAdder
...
def test_recording_an_indexed_file_hash_runs_on_a_worker_thread(
    ...
    monkeypatch.setattr("knorvia.knowledge.add_documents.RAGService", _OkRagService)
