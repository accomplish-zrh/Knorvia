"""Grant tool/exec whitelists: normalization and runtime resolution."""

from __future__ import annotations

import pytest

from knorvia.multi_user.grants import load_grant, normalize_grant, save_grant
from knorvia.multi_user.tool_access import (
    allowed_mcp_tools,
...
def grantable_alice(mu_isolated_root, monkeypatch):
    ...
    from knorvia.multi_user import grants
...
def test_normalize_migrates_v1_to_current():
    v1 = {
        "version": 1,
        "models": {
...
def test_saved_grant_round_trips_current_schema(grantable_alice):
