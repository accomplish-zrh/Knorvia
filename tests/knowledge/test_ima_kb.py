...
from knorvia.knowledge.kb_types import CONNECTED_KB_TYPES, IMA_KB_TYPE
...
def test_has_no_local_document_root(tmp_path) -> None:
    ...
    from knorvia.knowledge.manifest import document_root
...
def test_documents_are_reported_as_non_enumerable(tmp_path) -> None:
    ...
    from knorvia.knowledge.manifest import UNAVAILABLE_REMOTE, build_manifest
