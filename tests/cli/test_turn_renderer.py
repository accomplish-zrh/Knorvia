...
The chat agent loop (knorvia/agents/chat/agent_loop.py) streams every
...
from knorvia.app import TurnRequest
from knorvia_cli import common as cli_common
from knorvia_cli.common import _resolve_answer
...
def _install_fake_runtime(
    ...
    *,
    ...
    async def _submit_user_reply(self, turn_id, text=None, *, answers=None):
    ...
    monkeypatch.setattr("knorvia.app.facade.KnorviaApp.submit_user_reply", _submit_user_reply)
