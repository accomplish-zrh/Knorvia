...
def _install_stub_parse_service(monkeypatch, results: dict[str, "object"]) -> None:
    ...
    """
    import knorvia.services.parsing as parsing
...
def test_loader_routes_parser_files_through_active_parse_engine(
    ...
    from knorvia.services.rag.pipelines.llamaindex.document_loader import (
...
def test_loader_indexes_images_extracted_from_parsed_document(
    ...
    from knorvia.services.parsing.types import ParsedDocument
    from knorvia.services.rag.pipelines.llamaindex import document_loader as loader_module
...
def test_loader_embeds_images_with_qwen38_max_vision_capability(
    ...
    from knorvia.services.llm.client import LLMClient
