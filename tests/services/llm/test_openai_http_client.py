...
from knorvia.services.llm.exceptions import LLMConfigError
...
def test_provider_core_passes_disable_ssl_http_client(monkeypatch: pytest.MonkeyPatch) -> None:
    from knorvia.services.llm.provider_core import openai_compat_provider as provider_mod
...
def test_azure_provider_passes_disable_ssl_http_client(monkeypatch: pytest.MonkeyPatch) -> None:
    from knorvia.services.llm.provider_core import azure_openai_provider as azure_mod
...
async def test_sdk_complete_passes_disable_ssl_http_client(
    ...
    from knorvia.services.llm import executors
...
def test_embedding_sdk_passes_disable_ssl_http_client(
    ...
    from knorvia.services.embedding.adapters import openai_sdk as embedding_mod
