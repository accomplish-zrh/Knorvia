...
from knorvia.partners.channels import weixin as weixin_mod
from knorvia.partners.channels.registry import discover_all, discover_channel_names
from knorvia.partners.channels.weixin import (
...
class TestOutbound:
    ...
    async def test_send_text_posts_weixin_message(self, state_dir):
        ...
        assert body["msg"]["client_id"].startswith("knorvia-")
