...
from knorvia.services.embedding.adapters.base import EmbeddingRequest
from knorvia.services.embedding.adapters.cohere import CohereEmbeddingAdapter
from knorvia.services.embedding.adapters.jina import JinaEmbeddingAdapter
from knorvia.services.embedding.adapters.ollama import OllamaEmbeddingAdapter
from knorvia.services.embedding.adapters.openai_compatible import (
...
def _capture_url(monkeypatch: pytest.MonkeyPatch) -> dict[str, Any]:
    ...
    def fake_init(self: httpx.AsyncClient, **kwargs: Any) -> None:
