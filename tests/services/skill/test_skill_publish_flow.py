...
from knorvia.services.skill import taxonomy
...
class _CapturingProvider:
    ...
    def publish(self, *, slug, version, zip_bytes, token, fields):
...
def test_select_domains_resolution(monkeypatch: pytest.MonkeyPatch) -> None:
    from knorvia_cli import skill_prompts
    ...
    def fake_select_many(options, title, **kwargs):
        return calls.pop(0)
...
def test_parse_indices() -> None:
    from knorvia_cli.skill_prompts import _parse_indices
