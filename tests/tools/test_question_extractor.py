...
def _load_question_extractor_module():
    ...
    stubbed_modules = {
        "knorvia.services.config": {"get_agent_params": lambda *_args, **_kwargs: {}},
        "knorvia.services.llm": {"complete": lambda *_args, **_kwargs: None},
        "knorvia.services.llm.capabilities": {
            "supports_response_format": lambda *_args, **_kwargs: False
        },
        "knorvia.services.llm.config": {"get_llm_config": lambda: None},
        "knorvia.utils.json_parser": {"parse_json_response": lambda *_args, **_kwargs: {}},
    }
