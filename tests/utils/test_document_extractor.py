"""Tests for knorvia.utils.document_extractor."""
...
from knorvia.utils import document_extractor as document_extractor_module
...
class TestExtractDocumentsFromRecords:
    ...
    def test_limits_come_from_settings_layer(self, monkeypatch) -> None:
        ...
        from knorvia.services.config import runtime_settings as rs
