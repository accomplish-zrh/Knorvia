...
AGENTS_DIR = PROJECT_ROOT / "knorvia" / "agents"
# Modules that live outside knorvia/agents/ but still own prompts.
EXTRA_PROMPT_MODULE_DIRS = (
    PROJECT_ROOT / "knorvia" / "book",
    PROJECT_ROOT / "knorvia" / "co_writer",
)
