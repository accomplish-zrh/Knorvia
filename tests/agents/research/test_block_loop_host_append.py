...
def _make_pipeline(monkeypatch: pytest.MonkeyPatch) -> ResearchPipeline:
    ...
    monkeypatch.setattr(
        "knorvia.agents.research.pipeline.get_tool_registry", lambda: _FakeRegistry()
    )
...
def _make_pipeline_with_registry(
    ...
    *,
    ...
    monkeypatch.setattr("knorvia.agents.research.pipeline.exec_capability_available", lambda: True)
