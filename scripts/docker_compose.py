...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "Docker settings: "
        f"backend={values['KNORVIA_DOCKER_BACKEND_PORT']} "
        f"frontend={values['KNORVIA_DOCKER_FRONTEND_PORT']} "
        f"pocketbase={values['KNORVIA_DOCKER_POCKETBASE_PORT']}",
        file=sys.stderr,
    )
