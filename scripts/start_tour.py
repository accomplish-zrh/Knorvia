...
from knorvia_cli.init_cmd import run_init


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Create or update Knorvia settings under data/user/settings.",
    )
    parser.add_argument(
        "--cli",
        action="store_true",
